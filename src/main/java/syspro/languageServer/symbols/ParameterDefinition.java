...
public class ParameterDefinition implements SyntaxNodeWithSymbols {
    ...
    public ParameterDefinition(SemanticSymbol symbol, AnySyntaxKind kind, Token token, ASTNode... slots) {
        this.symbol = symbol;
        this.kind = kind;
