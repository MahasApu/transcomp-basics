...
public class TypeDefinition implements SyntaxNodeWithSymbols {
    ...
    public TypeDefinition(SemanticSymbol symbol, AnySyntaxKind kind, Token token, String type, ASTNode... slots) {
        this.symbol = symbol;
        this.kind = kind;
        this.type = type;
