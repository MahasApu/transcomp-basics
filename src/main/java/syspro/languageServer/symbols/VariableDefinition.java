...
public class VariableDefinition implements SyntaxNodeWithSymbols {
    ...
    public VariableDefinition(SemanticSymbol symbol, AnySyntaxKind kind, Token token, ASTNode... slots) {
        this.symbol = symbol;
        this.kind = kind;
